...
- **Total Events:** 28946
- **Unique Files:** 1677
- **Lines Added:** 6339828325
- **Lines Removed:** 106820259
- **Net Change:** 6233008066 lines
...
series:
  - title: Events
    data: [5342, 338, 598, 4903, 6142, 6274, 5349]
width: 80%
labelColors: true
beginAtZero: true
```
...
series:
  - title: Events
    data: [97, 22, 13, 27, 1569, 970, 6790, 1171, 5127, 6323, 3309, 3528]
width: 80%
labelColors: true
beginAtZero: true
```

...
<center><h1><font color="#ffffff"><u>Sunday, December 7th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">19°F • 33°F
<br>❄️ Partly cloudy throughout the day with afternoon rain or snow.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-06.md" data-href="Digital Hobonichi/2025/12-December/2025-12-06.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-08.md" data-href="Digital Hobonichi/2025/12-December/2025-12-08.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [w] 09:23 am - 09:57 am //  (Log Entry)
- [$] 10:28 am //  (Log Entry)
- [$] 10:34 am //  (Log Entry)
- [$] 10:40 am //  (Log Entry)
- [f] 11:00 am //  (Log Entry)
- [w] 11:08 am - 02:51 pm //  (Log Entry)
- [#] 12:33 pm //  (Log Entry)
- [t] 03:50 pm //  (Log Entry)
- [T] 03:55 pm //  (Log Entry)
- [P] 04:17 pm //  (Log Entry)
- [$] 05:11 pm //  (Log Entry)
- [S] 06:14 pm //  (Log Entry)
- [#] 06:32 pm //  (Log Entry)
- [#] 06:50 pm //  (Log Entry)
- [t] 07:48 pm //  (Log Entry)
...
| Cost    | Item         | Notes                                                   |
| ------- | ------------ | ------------------------------------------------------- |
| $105.49 | Trader Joe's | #finances/groceries |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-12-07) AND file.ctime <= date(2025-12-08) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-12-07) AND file.mtime <= date(2025-12-08) AND file.path != this.file.path

...
<center><h1><font color="#ffffff"><u>Tuesday, December 9th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">15°F • 37°F
<br>🌧️ Partly cloudy throughout the day with late afternoon rain or snow.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-08.md" data-href="Digital Hobonichi/2025/12-December/2025-12-08.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-10.md" data-href="Digital Hobonichi/2025/12-December/2025-12-10.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [H] 12:08 pm - 12:33 pm //  (Log Entry)
- [$] 12:43 pm //  (Log Entry)
- [B] 01:05 pm //  (Log Entry)
- [f] 01:15 pm //  (Log Entry)
- [T] 04:12 pm //  (Log Entry)
- [t] 04:18 pm //  (Log Entry)
- [P] 04:25 pm //  (Log Entry)
- [$] 04:47 pm //  (Log Entry)
- [f] 05:13 pm //  (Log Entry)
- [t] 07:48 pm //  (Log Entry)
- [o] 08:18 pm //  (Log Entry)
- [Z] 08:42 pm //  (Log Entry)
...
> FROM ""
> where file.ctime >= date(2025-12-09) AND file.ctime <= date(2025-12-10) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-12-09) AND file.mtime <= date(2025-12-10) AND file.path != this.file.path

...
<center><h1><font color="#ffffff"><u>Sunday, December 21st, 2025</u></font></h1></center>
<center><p><font color="#ffffff">20°F • 33°F
<br>🔆 Clear conditions throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-20.md" data-href="Digital Hobonichi/2025/12-December/2025-12-20.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-22.md" data-href="Digital Hobonichi/2025/12-December/2025-12-22.md" class="internal-link nav-button">Next Day →</a>
</div>


> As we risk ourselves, we grow. Each new experience is a risk.
> <cite>~ Fran Watson</cite>
...
- [Z] 08:42 am //  (Log Entry)
- [f] 10:07 am //  (Log Entry)
- [T] 11:13 am //  (Log Entry)
- [o] 11:24 am //  (Log Entry)
- [t] 12:39 pm //  (Log Entry)
- [H] 03:42 pm //  (Log Entry)
- [f] 05:10 pm //  (Log Entry)
- [B] 08:42 pm //  (Log Entry)
- [P] 08:59 pm //  (Log Entry)
- [Z] 09:26 pm //  (Log Entry)

## :LiPiggyBank: Spending
| Cost   | Item    | Notes                    |
| ------ | ------- | ------------------------ |
| $118.28 | Whole Foods | #finances/groceries |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-12-21) AND file.ctime <= date(2025-12-22) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-12-21) AND file.mtime <= date(2025-12-22) AND file.path != this.file.path

...
<center><h1><font color="#ffffff"><u>Monday, December 8th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">6°F • 23°F
<br>⛅ Partly cloudy throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-07.md" data-href="Digital Hobonichi/2025/12-December/2025-12-07.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-09.md" data-href="Digital Hobonichi/2025/12-December/2025-12-09.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [Z] 07:07 am //  (Log Entry)
- [t] 07:57 am //  (Log Entry)
- [P] 12:32 pm //  (Log Entry)
- [+] 01:15 pm - 01:52 pm //  (Log Entry)
- [#] 01:53 pm //  (Log Entry)
- [f] 02:12 pm //  (Log Entry)
- [M] 02:25 pm //  (Log Entry)
- [o] 06:38 pm //  (Log Entry)
- [c] 08:24 pm //  (Log Entry)
- [Z] 08:27 pm //  (Log Entry)
- [p] 09:48 pm //  (Log Entry)

## :LiPiggyBank: Spending
| Cost    | Item        | Notes                               |
| ------- | ----------- | ----------------------------------- |
| $19.25 | Bakery | #finances/breakfast |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-12-08) AND file.ctime <= date(2025-12-09) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-12-08) AND file.mtime <= date(2025-12-09) AND file.path != this.file.path

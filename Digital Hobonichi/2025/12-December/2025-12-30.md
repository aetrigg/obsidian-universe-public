...
<center><h1><font color="#ffffff"><u>Tuesday, December 30th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">14°F • 25°F
<br>⛅ Partly cloudy throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-29.md" data-href="Digital Hobonichi/2025/12-December/2025-12-29.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/12-December/2025-12-31.md" data-href="Digital Hobonichi/2025/12-December/2025-12-31.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [t] 07:19 am //  (Log Entry)
- [m] 07:39 am //  (Log Entry)
- [h] 10:56 am //  (Log Entry)
- [t] 11:10 am //  (Log Entry)
- [f] 12:00 pm //  (Log Entry)
- [B] 12:01 pm - 12:30 pm //  (Log Entry)
- [P] 12:31 pm - 12:41 pm //  (Log Entry)
- [t] 02:10 pm //  (Log Entry)
- [t] 05:24 pm //  (Log Entry)
- [$] 06:26 pm //  (Log Entry)
- [f] 07:18 pm //  (Log Entry)
- [t] 07:44 pm //  (Log Entry)
- [B] 07:45 pm - 08:44 pm //  (Log Entry)
- [P] 08:45 pm - 08:54 pm //  (Log Entry)
- [o] 08:55 pm - 09:48 pm //  (Log Entry)
- [Z] 10:08 pm //  (Log Entry)


## :LiPiggyBank: Spending
| Cost   | Item                      | Notes                                                   |
| ------ | ------------------------- | ------------------------------------------------------- |
| $18.40 | Burrito Place | #finances/lunch |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-12-30) AND file.ctime <= date(2025-12-31) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-12-30) AND file.mtime <= date(2025-12-31) AND file.path != this.file.path

...
<center><h1><font color="#ffffff"><u>Sunday, November 16th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">33°F • 53°F
<br>🔆 Clear conditions throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-15.md" data-href="Digital Hobonichi/2025/11-November/2025-11-15.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-17.md" data-href="Digital Hobonichi/2025/11-November/2025-11-17.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [D] 08:45 am //  (Log Entry)
- [t] 08:52 am //  (Log Entry)
- [z] 09:12 am //  (Log Entry)
- [T] 10:32 am //  (Log Entry)
- [T] 03:00 pm //  (Log Entry)
- [$] 05:04 pm //  (Log Entry)
- [f] 06:00 pm //  (Log Entry)
- [t] 06:59 pm //  (Log Entry)
- [T] 08:09 pm //  (Log Entry)
- [P] 08:33 pm //  (Log Entry)


## :LiPiggyBank: Spending
| Cost   | Item     | Notes                                                   |
| ------ | -------- | ------------------------------------------------------- |
| $105.25 | Safeway | #finances/groceries |
| $11.54 | McDonalds | #finances/fastfood |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-11-16) AND file.ctime <= date(2025-11-17) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-11-16) AND file.mtime <= date(2025-11-17) AND file.path != this.file.path

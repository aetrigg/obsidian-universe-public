...
<center><h1><font color="#ffffff"><u>Monday, November 10th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">25°F • 30°F
<br>⛅ Partly cloudy throughout the day with snow clearing later.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-09.md" data-href="Digital Hobonichi/2025/11-November/2025-11-09.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-11.md" data-href="Digital Hobonichi/2025/11-November/2025-11-11.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [T] 07:59 am //  (Log Entry)
- [#] 08:37 am //  (Log Entry)
- [#] 09:31 am - 09:38 am //  (Log Entry)
- [E] 11:37 am //  (Log Entry)
- [T] 01:25 pm //  (Log Entry)
- [$] 01:32 pm //  (Log Entry)
- [P] 01:53 pm //  (Log Entry)
- [f] 02:02 pm //  (Log Entry)
- [o] 02:09 pm //  (Log Entry)
- [P] 02:33 pm //  (Log Entry)
- [o] 04:04 pm //  (Log Entry)
- [f] 04:39 pm //  (Log Entry)
- [T] 05:44 pm //  (Log Entry)
- [E] 07:23 pm //  (Log Entry)


## :LiPiggyBank: Spending
| Cost    | Item          | Notes                                                 |
| ------- | ------------- | ----------------------------------------------------- |
| $6.75 | DoorDash | #finances/delivery |
```dataviewjs
...
## :LiActivitySquare: Changes in the Universe Today
...
> FROM ""
> where file.ctime >= date(2025-11-10) AND file.ctime <= date(2025-11-11) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-11-10) AND file.mtime <= date(2025-11-11) AND file.path != this.file.path

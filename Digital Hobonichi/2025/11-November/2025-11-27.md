...
<center><h1><font color="#ffffff"><u>Thursday, November 27th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">26°F • 33°F
<br>☁️ Cloudy skies throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-26.md" data-href="Digital Hobonichi/2025/11-November/2025-11-26.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-28.md" data-href="Digital Hobonichi/2025/11-November/2025-11-28.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [Z] 11:45 am //  (Log Entry)
- [m] 11:47 am //  (Log Entry)
- [T] 11:48 am - 02:25 pm //  (Log Entry)
- [f] 12:41 pm //  (Log Entry)
- [t] 02:27 pm //  (Log Entry)
- [B] 02:29 pm - 04:07 pm //  (Log Entry)
- [T] 04:28 pm //  (Log Entry)
- [m] 04:49 pm - 05:37 pm //  (Log Entry)
- [m] 05:39 pm - 06:01 pm //  (Log Entry)
- [t] 06:00 pm //  (Log Entry)
- [t] 08:56 pm //  (Log Entry)
- [f] 09:03 pm //  (Log Entry)
- [Z] 09:39 pm //  (Log Entry)


## :LiPiggyBank: Spending
| Cost | Item | Notes |
| ---- | ---- | ----- |
| $20.20 | Sushi Place | #finances/dinner |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-11-27) AND file.ctime <= date(2025-11-28) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-11-27) AND file.mtime <= date(2025-11-28) AND file.path != this.file.path

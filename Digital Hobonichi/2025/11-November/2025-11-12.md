...
<center><h1><font color="#ffffff"><u>Wednesday, November 12th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">35°F • 49°F
<br>🔆 Clear conditions throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-11.md" data-href="Digital Hobonichi/2025/11-November/2025-11-11.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-13.md" data-href="Digital Hobonichi/2025/11-November/2025-11-13.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [H] 12:05 pm - 12:33 pm //  (Log Entry)
- [o] 01:09 pm //  (Log Entry)
- [m] 04:41 pm //  (Log Entry)
- [p] 05:55 pm //  (Log Entry)
- [$] 07:09 pm //  (Log Entry)
- [o] 07:25 pm //  (Log Entry)
- [$] 08:07 pm //  (Log Entry)
- [o] 08:20 pm //  (Log Entry)
- [T] 08:24 pm //  (Log Entry)
- [f] 08:41 pm //  (Log Entry)

## :LiPiggyBank: Spending
| Cost   | Item          | Notes                                                  |
| ------ | ------------- | ------------------------------------------------------ |
| $17.39 | Haircut | #finances/personal |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-11-12) AND file.ctime <= date(2025-11-13) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-11-12) AND file.mtime <= date(2025-11-13) AND file.path != this.file.path

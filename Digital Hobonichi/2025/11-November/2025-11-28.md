...
<center><h1><font color="#ffffff"><u>Friday, November 28th, 2025</u></font></h1></center>
<center><p><font color="#ffffff">19°F • 31°F
<br>🔆 Clear conditions throughout the day.</font></p></center>



<div class="nav-header">
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-27.md" data-href="Digital Hobonichi/2025/11-November/2025-11-27.md" class="internal-link nav-button">← Previous Day</a>
  ...
  <a href="Digital%20Hobonichi/2025/11-November/2025-11-29.md" data-href="Digital Hobonichi/2025/11-November/2025-11-29.md" class="internal-link nav-button">Next Day →</a>
</div>
...
- [t] 07:22 am //  (Log Entry)
- [c] 07:56 am //  (Log Entry)
- [m] 12:29 pm //  (Log Entry)
- [z] 12:30 pm //  (Log Entry)
- [W] 01:17 pm //  (Log Entry)
- [Z] 01:56 pm //  (Log Entry)
- [o] 02:44 pm //  (Log Entry)
- [B] 02:45 pm - 03:50 pm //  (Log Entry)
- [$] 03:51 pm //  (Log Entry)
- [f] 05:49 pm //  (Log Entry)
- [t] 07:43 pm //  (Log Entry)
- [B] 07:45 pm - 11:10 pm //  (Log Entry)
- ["] 09:45 pm //  (Log Entry)
- [Z] 11:11 pm //  (Log Entry)
## :LiPiggyBank: Spending
| Cost    | Item                   | Notes                                  |
| ------- | ---------------------- | -------------------------------------- |
| $14.42 | Bagel Shop | #finances/breakfast |
```dataviewjs
...
> FROM ""
> where file.ctime >= date(2025-11-28) AND file.ctime <= date(2025-11-29) AND file.path != this.file.path
...
> FROM ""
> where file.mtime >= date(2025-11-28) AND file.mtime <= date(2025-11-29) AND file.path != this.file.path
